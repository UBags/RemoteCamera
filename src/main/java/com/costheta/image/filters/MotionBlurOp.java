package com.costheta.image.filters;

import com.costheta.image.filters.AbstractBufferedImageOp;
...
public class MotionBlurOp extends AbstractBufferedImageOp {
    ...
    public BufferedImage filter(BufferedImage src, BufferedImage dst) {
        ...
        for (int i = 0; i < steps; i++) {
            ...
            g.scale(1.0001 + scale, 1.0001 + scale); // The .0001 works round a bug on Windows where drawImage throws an
