...
public class LeftSideTextProcessor extends BaseClipImageProcessor {

    private static final Logger logger = LogManager.getLogger(LeftSideTextProcessor.class);
    private int imageCounter = 1;
    private static int connectivity = 4;

    public LeftSideTextProcessor(String name, ArrayList<String> patterns) {
        super(name, patterns);
        logger.trace("Leaving constructor");
    }

    public LeftSideTextProcessor(String name, ArrayList<String> patterns, int assessmentRegions) {
    ...
    public ProcessingResult process(BufferedImage image) {
        ...
        Pix BLG1 = Leptonica1.pixBilateralGray(normBackPix1, 20f, 75f, 16, 4);
...
//        pixWrite(imageCounter + " - " + imageSerialCounter++ + " - BLG2.png", BLG2, ILeptonica.IFF_PNG, TraceLevel.TRACE);
        ...
        int success = 1;
        success = Leptonica1.pixSauvolaBinarizeTiled(BLG1, 25, 0.2f,
                8,
                8, null, pbrSauvola1);
