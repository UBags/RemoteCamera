...
public class WebcamAppLauncher extends Application {
    ...
    protected void setImageViewSize() {
        ...
        imgWebCamCapturedImage.setFitHeight(WebcamResolution.VGA.getSize().getHeight());
        imgWebCamCapturedImage.setFitWidth(WebcamResolution.VGA.getSize().getWidth());
        imgWebCamCapturedImage.prefHeight(WebcamResolution.VGA.getSize().getHeight());
        imgWebCamCapturedImage.prefWidth(WebcamResolution.VGA.getSize().getWidth());
        ...
        Task<Void> webCamTask = new Task<Void>() {
            ...
            protected Void call() throws Exception {
                ...
                if (webCam != null) {
                    ...
                    webCam.setCustomViewSizes(new Dimension[] { WebcamResolution.FHD.getSize() }); // register custom
