...
public class Processor2 extends PartProcessor {

    private static String inputDirectory = "E:\\TechWerx\\CosTheta\\IntelliJ IDEA Projects\\RemoteCamera\\100001\\20210406202037\\Inspection Point 1";
    private static String fileName = "1-original.jpg";
    public static String debugDirectory = inputDirectory + "/" + "debug";

    public static void main(String[] args) throws TesseractException, IOException {

        System.out.println("Running Processor 2");
        try {
        ...
        patterns1.add("ADDDA");
        patterns1.add("AADDD");
        Processor2 aProcessor = new Processor2(patterns1);
    ...
    public Processor2(ArrayList<String> patterns) {
        super(patterns);
    }
...
//        Pix pixUnMaGrayMasked = Leptonica1.pixOr(null, pixUnMaGray, finalMask);
        ...
        ImageUtils.writeFile(originalMask1BI, "png", debugDirectory + "4BI - Original Mask 1 Closed.png");

        BufferedImage original_Masked_Morphed = ImageUtils.dilateGrayBIWithFilter(originalMask1BI, 5, 3,180,ImageUtils.BLACK);
        ImageUtils.writeFile(original_Masked_Morphed, "png", debugDirectory + "5 - Original Mask 1 Closed.png");
        ...
        original_Masked_Morphed = ImageUtils.openGrayBI(original_Masked_Morphed, 5,3);
...
//        ImageUtils.writeFile(maskedOriginalGE, "png", debugDirectory + "6 - Original Mask 1 GE.png");
        ...
        Pix finalMask = Leptonica1.pixErodeGray(newMask_8bpp, 3, 3);
        ...
        BufferedImage GEUMImage3 = ImageUtils.relativeGammaContrastEnhancementWithPercentTolerance(originalMaskedBI, 21, 5, 0.125);
        ImageUtils.writeFile(GEUMImage3, "png", debugDirectory + "10A - RGE_PercentTol.png");

        GEUMImage3 = ImageUtils.relativeScaledGammaContrastEnhancementSkipWhites(GEUMImage3, 35, 13,
                50, 240);
        ImageUtils.writeFile(GEUMImage3, "png", debugDirectory + "11 - Original GE.png");

        GEUMImage3 = ImageUtils.erodeGrayBIWithFilter(GEUMImage3, 1, 5,
                96, ImageUtils.BLACK);
        ImageUtils.writeFile(GEUMImage3, "png", debugDirectory + "12 - Original GE.png");

        GEUMImage3 = ImageUtils.dilateGrayBIWithFilter(GEUMImage3, 1, 5,
                164, ImageUtils.WHITE);
        GEUMImage3 = ImageUtils.eliminateBlackBridgesIteratively(GEUMImage3, 2, 128,
...
//        BufferedImage binarizedBI = ImageUtils.convertPixToImage(binarizedPix);
        ...
        Pix binarizedPixBridgesCleaned = ImageUtils.getDepth1Pix(binarizedBI, 128);

        Pix cleanedBinarizedPix1 = ImageUtils.removeLines(binarizedPixBridgesCleaned,ImageUtils.VERTICAL_DIRECTION, 40);
        Leptonica1.pixWrite(debugDirectory + "15 - Cleaned Binarized Pix - 1.png", cleanedBinarizedPix1, ILeptonica.IFF_PNG);
        LeptUtils.dispose(binarizedPixBridgesCleaned);
        ...
        lines = TesseractUtils.forceFitIntoOneLineMultiColumns(lines);
...
//        Leptonica1.pixWrite(debugDirectory + "Final pix.png", pixUnMaGrayMasked, ILeptonica.IFF_PNG);
        ...
        int erodeOrDilate = ImageUtils.ERODE;
