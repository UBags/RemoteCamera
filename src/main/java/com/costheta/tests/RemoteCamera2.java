...
public class RemoteCamera2 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.setOnCloseRequest(new EventHandler<WindowEvent>() {
            ...
            public void handle(WindowEvent e) {
                int response = RemoteCamera2.this.closeWindowEvent(primaryStage);
                if (response == 1) {
...
//        });
    ...
    public static final String getCameraConnectedStatus() {
        return "";
    }
