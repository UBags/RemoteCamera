...
public class BottomCameraProcessor extends CameraProcessor {

    protected BottomCameraProcessor(String cameraName, int cameraId, ImageView imageView, int udpPort, Client client, boolean connected) {
