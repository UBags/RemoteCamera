...
public class Processor3 extends PartProcessor {

    private static String inputDirectory = "E:\\TechWerx\\CosTheta\\IntelliJ IDEA Projects\\RemoteCamera\\100001\\20210407111816\\Inspection Point 1";
    private static String fileName = "5-original.jpg";
    public static String debugDirectory = inputDirectory + "/" + "debug";

    public static void main(String[] args) throws TesseractException, IOException {

        System.out.println("Running Processor 3");
        try {
        ...
        patterns1.add("DDDDD");
        patterns1.add("DDDDD");
        Processor3 aProcessor = new Processor3(patterns1);
        aProcessor.process(image);
        System.exit(0);
    }

    public Processor3(ArrayList<String> patterns) {
        super(patterns);
    }
    ...
    public void process(BufferedImage image) {
        ...
        // System.out.println(originalPixLarge);
        // Box clipBox = Leptonica1.boxCreate(790, 875, 600, 200);
        Box clipBox = Leptonica1.boxCreate(725, 850, 675, 225);
        Pix originalPix = Leptonica1.pixClipRectangle(originalPixLarge, clipBox, null);
        // System.out.println(originalPix);
        ...
        Leptonica1.pixWrite(debugDirectory + "1A - BN Image.png", bnPix, ILeptonica.IFF_PNG);

        Pix cnPix = Leptonica1.pixContrastNorm(null, bnPix, 18,
                bnPix.h / 5, 100, 2, 2);
        Leptonica1.pixWrite(debugDirectory + "1B - CN Image.png", cnPix, ILeptonica.IFF_PNG);

        BufferedImage cnImage = ImageUtils.convertPixToImage(cnPix);
        BufferedImage RGE_CNImage = ImageUtils.relativeGammaContrastEnhancement(cnImage, 15, 19);
        ImageUtils.writeFile(RGE_CNImage, "png", debugDirectory + "1C - RGE_CN Image.png");

        BufferedImage RGE_CNImage_Adjusted = ImageUtils.lightenCentreCellsYAxis(RGE_CNImage, 5, 5);
        ImageUtils.writeFile(RGE_CNImage_Adjusted, "png", debugDirectory + "1D - RGE_CN_Adjusted Image.png");

        BufferedImage closedBI = ImageUtils.closeGrayBI (RGE_CNImage_Adjusted, 15, 5);
        ImageUtils.writeFile(closedBI, "png", debugDirectory + "1E - Dilated Image.png");

        BufferedImage bin_closedBI_Temp = ImageUtils.binarize(closedBI, 128);
        ImageUtils.writeFile(bin_closedBI_Temp, "png", debugDirectory + "1F - Binarized Image.png");

        BufferedImage aMaskBI = ImageUtils.invert(bin_closedBI_Temp);
        ImageUtils.writeFile(aMaskBI, "png", debugDirectory + "1G - Mask.png");

//        BufferedImage maskedOriginalBI = ImageUtils.imageMask(RGE_CNImage, bin_closedBI);
//        ImageUtils.writeFile(maskedOriginalBI, "png", debugDirectory + "1G - Masked Original.png");
        ...
        System.out.println("Depth = " + RGE_CN_Pix.d);
        int success = Leptonica1.pixSauvolaBinarizeTiled(RGE_CN_Pix, 11, 0.2f,
                2,2, null, pbrSauvola);
        System.out.println("Sauvola success = " + success);
        Pix pixSauvola = new Pix(pbrSauvola.getValue());
        Leptonica1.pixWrite(debugDirectory + "1H - Sauvola.png", pixSauvola, ILeptonica.IFF_PNG);

        Pix pixSauvolaCleaned = ImageUtils.removeSaltPepper(pixSauvola);
        Leptonica1.pixWrite(debugDirectory + "1I - Sauvola - SP Cleaned.png", pixSauvolaCleaned, ILeptonica.IFF_PNG);
        ...
        Leptonica1.pixWrite(debugDirectory + "1I - Sauvola - Lines Removed.png", pixSauvolaLinesRemoved, ILeptonica.IFF_PNG);
        ...
        ImageUtils.writeFile(processedAndMaskedBI, "png", debugDirectory + "1K - MaskedOriginal.png");

//        BufferedImage bin_RGE_CN = ImageUtils.binarize(RGE_CNImage, 12);
//        ImageUtils.writeFile(bin_RGE_CN, "png", debugDirectory + "1D - binarized RG_CN Image.png");
...
//        ImageUtils.writeFile(maskedOriginalGE, "png", debugDirectory + "6 - Original Mask 1 GE.png");
        ...
        Pix originalFinalMasked =  Leptonica1.pixOr(null, cnPix, finalMask);
...
//        BufferedImage binarizedBI = ImageUtils.convertPixToImage(binarizedPix);
        ...
        Leptonica1.pixWrite(debugDirectory + "1L - Cleaned Binarized Pix.png", cleanedBinarizedPix, ILeptonica.IFF_PNG);
        ...
        Leptonica1.pixWrite(debugDirectory + "1M - Small bits cleaned.png", copy, ILeptonica.IFF_PNG);
        ...
        Leptonica1.pixWrite(debugDirectory + "1N - Rotated.png", rotatedPix, ILeptonica.IFF_PNG);
        ...
        Leptonica1.pixWrite(debugDirectory + "1O - Sauvola Rotated.png", sauvolaRotatedPix, ILeptonica.IFF_PNG);
        ...
        ArrayList<ArrayList<Rectangle>> lines = TesseractUtils.getBoundingBoxes(rotatedPix, 7, 2, 1, 15, 15);
        ArrayList<ArrayList<Rectangle>> twoLines = TesseractUtils.arrangeInto2Lines(lines);
        System.out.println("After arranging into 2 lines : " + twoLines);

        Pix pixWithE2ELines = TesseractUtils.getPixWithE2ELines(sauvolaRotatedPix, twoLines);
        Leptonica1.pixWrite(debugDirectory + "1P - Final Picture.png", pixWithE2ELines, ILeptonica.IFF_PNG);
        lines = TesseractUtils.getBoundingBoxes(pixWithE2ELines, 7, 2, 1, 15, 15);
...
//        Leptonica1.pixWrite(debugDirectory + "Final pix.png", pixUnMaGrayMasked, ILeptonica.IFF_PNG);
        ...
        Pixa pixArrayForTesseract = ImageUtils.getDerivativeImages(pixWithE2ELines, lines, scalingFactors, erodeOrDilate);
